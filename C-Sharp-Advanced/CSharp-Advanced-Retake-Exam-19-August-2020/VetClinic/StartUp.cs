...
namespace VetClinic
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            // Initialize entity
            Pet dog = new Pet("Mili Vanili", 5, "Tim");
            ...
            Pet bunny = new Pet("Zak", 2, "Jon");
            Pet pony = new Pet("Pony", 2, "Karol");
            ...
            Pet nonExistingPet = clinic.GetPet("Mimi", "Jiji");
            Console.WriteLine(nonExistingPet);
